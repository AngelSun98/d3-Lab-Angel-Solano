...
class Character:
    ...
    def battle(self, proctectionValue : float) -> float:
        return self._damage / proctectionValue
    ...
    def GetDamange(self, finalDamage : float):
        self._health = self._health-finalDamage
